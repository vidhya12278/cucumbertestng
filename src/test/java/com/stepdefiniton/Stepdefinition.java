...
import com.pom.Orderno;
import com.pom.Searchpage;
import com.singleton.maintainpage;
...
public class Stepdefinition extends Helperclass {
	...
	public void i_should_enters_and(String string, String string2)
	{
		...
		//org.testng.Assert.assertEquals("verify username","vidhyaes",getattribute(u));
		WebElement p = login.getPass();
		type(p,string2);
		System.out.println("password : " + getattribute(p));
		//org.testng.Assert.assertEquals("verify password", "vid@98",getattribute(p));
